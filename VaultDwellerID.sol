...
/**
 * @title VaultDwellerID
 * @dev Represents identification of a VaultDweller
 */
contract VaultDwellerID {
     ...
     */
    function getDweller() external view returns (
        address address_, 
        bytes32 name_,
     ...
     */
    function getDwellerAddress() external view returns (address) {
        return dweller;
    }
     ...
     * @return dweller name
     */
    function getDwellerName() external view returns (bytes32) {
        return name;
    }
     ...
     */
    function getPhoto() public view returns (bytes memory) {
     ...
     * @param _name What should we call you, dweller?
     */
    function setDwellerName(bytes32 _name) public isOwner {
        name = _name;
    }
     ...
     */
    function setPhoto(bytes32[2] memory hash) public isOwner {
        photoHashBeg = hash[0];
        photoHashEnd = hash[1];
